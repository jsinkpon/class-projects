...
function isValid(word){
  ...
  tiles.forEach(function(c){
    c = c.toLowerCase();
    if (Object.hasOwn(availableTiles, c) == false){
      Object.defineProperty(availableTiles, c, {value: 1, configurable: false, writable: true, enumerable: true});
    }
    else{
      availableTiles[c] += 1;
    }
  ...
  if (possible_words.find(w => w == word) !== undefined){
    return true;
  }
  return false;
}
